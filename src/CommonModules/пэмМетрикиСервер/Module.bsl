...
Функция УдалятьРегламентноеЗадание(Знач Параметры)
	...
	Возврат (Параметры.Предопределенное И ЗначениеЗаполнено(Параметры.УникальныйИдентификатор))
		ИЛИ	(НЕ Параметры.Предопределенное И ЗначениеЗаполнено(Параметры.УникальныйИдентификатор) 
